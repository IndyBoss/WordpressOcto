(function() {
    ...
    */
    ...
    function oa(a) {
        return a instanceof C && a.constructor ===
            C && a.b === na ? a.a :
            "type_error:Const"
    }
    function D(a) {
    ...
    E.g.N = {
        ...
        ba: {
            ...
            calendar: ["fw"],
            charteditor: "ui corechart imagechart annotatedtimeline gauge motionchart orgchart table"
                .split(" "),
            charteditor_base: "ui_base corechart imagechart annotatedtimeline gauge motionchart orgchart table_base"
                .split(" "),
            circles: ["fw",
                "d3"
            ],
    ...
    function G(a) {
        if (a instanceof F && a.constructor ===
            F && a.b === Aa) return a
            .a;
        u(a);
    ...
    function Ba(a, b) {
        var c = oa(a);
        if (!Ca.test(c)) throw Error(
            "Invalid TrustedResourceUrl format: " +
            c);
        a = c.replace(Da, function(
            d, e) {
            if (!Object.prototype
                .hasOwnProperty
                .call(b, e)
    ...
    function Pa() {
        var a = Qa;
        if (a instanceof J && a.constructor ===
            J && a.b === Oa) return a
            .a;
        u(a);
    ...
    var Va = I("Opera"),
        ...
        Xa = I("Edge"),
        Ya = I("Gecko") && !(-1 !=
            H.toLowerCase().indexOf(
                "webkit") && !I(
                "Edge")) && !(I(
            "Trident") || I(
            "MSIE")) && !I("Edge"),
        Za = -1 != H.toLowerCase().indexOf(
            "webkit") && !I("Edge"),
        $a;
    a: {
        var ab = "",
            bb = function() {
                ...
                if (Xa) return /Edge\/([\d\.]+)/
                    .exec(a);
                if (Wa) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/
                    .exec(a);
                if (Za) return /WebKit\/(\S+)/
                    .exec(a);
                if (Va) return /(?:Version)[ \/]?(\S+)/
                    .exec(a)
            }();bb && (ab = bb ?
            bb[1] : "");
        if (Wa) {
            var cb, db = p.document;
            cb = db ? db.documentMode :
                void 0;
            if (null != cb &&
                cb > parseFloat(
                    ab)) {
    ...
    function rb() {
        var a = sb,
            b = null;
        a.a && (b = a.a, a.a = a.a.next,
            a.a || (a.b = null),
            b.next = null);
        return b
    }
    function pb() {
        this.next = this.b = this.a =
            null
    }
    ...
    */
    ...
    function Mb(a) {
        if (a.i && a.a && Ob(a)) {
            var b = a.i,
                c = Pb[b];
            c && (p.clearTimeout(c.a),
                delete Pb[b]);
            a.i = 0
        }
        a.b && (a.b.l--, delete a.b);
        b = a.c;
        for (var d = c = !1; a.h.length &&
            !a.j;) {
            var e = a.h.shift(),
                g = e[0],
                f = e[1];
    ...
    function jc(a, b, c) {
        b instanceof W ? (a.c = b,
            qc(a.c, a.i)) : (c ||
            (b = lc(b, rc)), a.c =
            new W(b, a.i))
    }
    function V(a, b) {
        return a ? b ? decodeURI(a.replace(
            /%25/g, "%2525"
        )) : decodeURIComponent(
            a) : ""
    }
    ...
    function Bc(a) {
        ...
        do {
            if (b === E.g.H[b])
                throw Error(
                    "Infinite loop in version mapping: " +
                    b);
            (c = E.g.H[b]) && (b =
                c)
        } while (c);
    ...
    function Cc(a) {
        var b = E.g.N.W[xc].loader,
            c = Bc(a);
        return E.g.m.load(b, {
            version: c.T
        }).then(function() {
            var d = q(
                "google.charts.loader.VersionSpecific.load"
            ) || q(
                "google.charts.loader.publicLoad"
            ) || q(
                "google.charts.versionSpecific.load"
            );
            if (!d) throw Error(
                "Bad version: " +
                a);
            wc = function(e) {
                ...
                if (
                    ...
                    var
                        g =
                        q(
                            "google.charts.loader.publicSetOnLoadCallback"
                        ) ||
                        q(
                            "google.charts.versionSpecific.setOnLoadCallback"
                        );
                    e =
                        new Promise(
                            function(
    ...
    y(
        ...
        E.L);
    var Ec = D(
            "https://maps.googleapis.com/maps/api/js?jsapiRedirect=true"
        ),
        Fc = D(
    ...
    function Kc(a, b) {
        var c;
        do {
            if (a === b[a]) throw Error(
                "Infinite loop in version mapping for version " +
                a);
            (c = b[a]) && (a = c)
        } while (c);
        return a
