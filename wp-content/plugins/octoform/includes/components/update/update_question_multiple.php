...
function update_question_multiple($a, $qid) {
  global $wpdb;
  ...
  for ($i=1; $i < 16; $i++) {
    ...
    $result .='><b>Keuze ' .$i.'</b></label><input type="text" placeholder="Keuze" name="multiple_'.$i.'" class="multipleText" ';
    if (isset($pieces[$i])) {
  ...
  $result .='<input type="hidden" name="qtype" value="1">
              ...
              <input type="hidden" name="alert" value="Multiple-choice vraag aangepast.">
